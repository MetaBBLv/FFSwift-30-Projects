...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        navigationController?.navigationBar.tintColor = UIColor(red: 241.90/255, green: 107.0/255, blue: 38.0/255, alpha: 1.0)
        configureTableView()
    }
    ...
    func configureTableView() {
        ...
        tblContacts.register(UINib(nibName: "ContactBirthdayTableViewCell", bundle: nil), forCellReuseIdentifier: "idCellContactBirthday")
    }
...
extension ViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "idCellContactBirthday") as! ContactBirthdayTableViewCell
        ...
        if !currentContact.isKeyAvailable(CNContactBirthdayKey) || !currentContact.isKeyAvailable(CNContactImageDataKey) || !currentContact.isKeyAvailable(CNContactEmailAddressesKey) {
            ...
            if let homeEmailAddress = homeEmailAddress {
                ...
                cell.lblEmail.text = "Not availabel home email"
            }
        }
