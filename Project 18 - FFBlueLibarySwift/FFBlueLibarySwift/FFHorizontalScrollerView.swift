...
protocol HorizontalScrollerDataSource: class {
    // numbar of views to present inside the horizontal scroller
...
extension HorizontalScrollerDataSource {
    func initialViewIndex(_ scroller: FFHorizontalScrollerView) -> Int {
        return 0
    }
}
...
class FFHorizontalScrollerView: UIView {
    ...
    @objc func scrollerDidTap(_ gesture: UIGestureRecognizer) {
...
extension FFHorizontalScrollerView: UIScrollViewDelegate {
...
fileprivate extension Selector {
    static let scrollerDidTap = #selector(FFHorizontalScrollerView.scrollerDidTap(_:))
}
