//
//  FFPhotoCommentViewController.swift
//  FFPhotoScroll
//
...
class FFPhotoCommentViewController: UIViewController {
...
fileprivate extension Selector {
    static let keyboardWillShowHandler = #selector(FFPhotoCommentViewController.keyboardWillShow(notification:))
    static let keyboardWillHideHandler = #selector(FFPhotoCommentViewController.keyboardWillHide(notification:))
    static let generalTap = #selector(FFPhotoCommentViewController.dismissKeyBoard)
    static let zoomTap = #selector(FFPhotoCommentViewController.openZoomingController(sender:))
}
