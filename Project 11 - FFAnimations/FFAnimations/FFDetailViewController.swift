...
class FFDetailViewController: UIViewController {
    ...
    @IBAction func didTapAnimate(_ sender: Any) {
        ...
        case "Multicolor":
            multColor(UIColor.green, UIColor.blue)
        ...
        case "Color and Frame Change":
            ...
            let secondFrame = currentFrame.insetBy(dx: 10, dy: 15)
    ...
    fileprivate func multColor(_ firstColor: UIColor, _ secondColor: UIColor) {
    ...
    fileprivate func curvePath(_ endPoint: CGPoint, controlPoint1: CGPoint, controlPoint2: CGPoint) {
        ...
        //creat a new CAKeyframeAnimation that animates the objects position
        let anim = CAKeyframeAnimation(keyPath: "position")
        
        // set the animations path to our bezier curve
        anim.path = path.cgPath
        
        //set some more parameters for the animnation
