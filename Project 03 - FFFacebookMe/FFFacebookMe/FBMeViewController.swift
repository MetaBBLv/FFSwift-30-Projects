...
class FBMeViewController: FBMeBaseViewController {
    ...
    override func viewDidLoad() {
        ...
        view.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|-0-[tableView]-0-|", options: NSLayoutConstraint.FormatOptions.directionLeadingToTrailing, metrics: nil, views: ["tableView": tableView]))
    }
...
extension FBMeViewController: UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, willDisplay cell: UITableViewCell, forRowAt indexPath: IndexPath) {
        ...
        if title == TableKeys.seeMord || title == TableKeys.addFavorites {
