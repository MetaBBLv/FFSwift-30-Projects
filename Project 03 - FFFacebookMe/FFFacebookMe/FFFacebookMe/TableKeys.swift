...
public struct TableKeys {
    ...
    static func populate(withUser user: FBMeUser) -> [[String: Any]] {
        return [
            [
                TableKeys.Rows:[
                    [TableKeys.ImageName:user.avatarName, TableKeys.Title: user.name,TableKeys.SubTitle: user.education]
                ]
            ],
            [
                TableKeys.Rows:[
                    ...
                    [TableKeys.Title: TableKeys.seeMord]
                ]
            ],
            [
